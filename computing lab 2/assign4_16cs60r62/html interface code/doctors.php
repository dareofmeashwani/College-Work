...
function extracredential($temp,$fit)
{
    ...
    $sqlquery = 'SELECT name as NAME,a.email as "E Mail",mobno as "Mobile No.",specialization as Specialization FROM account a,speciality s WHERE a.email=s.email and a.type LIKE "%doctor%";';
