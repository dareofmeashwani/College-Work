...
<div class="display_noti">
    ...
    <div class="status">
        <form name="viewdiagnosisform" method="post" action="viewdiagnosis.php">
            <?php
        ...
        <form name="addappointmentfinalizeform" action="viewdiagnosis.php" method="post">
            <?php
            ...
            echo '<textarea name="answer"  rows="4" cols="50"  readonly>'.$dvalue.'</textarea>';
            }
            ?>
        </form>
        <?php
